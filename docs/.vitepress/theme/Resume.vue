        ...
        <p class="contact">
          <template v-for="(c, i) in frontmatter.contacts" :key="i">
            <a v-if="c.href" :href="c.href" :target="c.href.startsWith('mailto') ? null : '_blank'" rel="noopener" class="contact-icon" :aria-label="c.text" :title="c.text">
              ...
              <!-- blogger -->
              <svg v-else-if="c.href.includes('blogspot')" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M21.976 24H2.026C.908 24 0 23.09 0 21.974V2.026C0 .91.908 0 2.026 0h19.95C23.092 0 24 .91 24 2.026v19.948C24 23.09 23.092 24 21.976 24zm-10.81-17.846H7.498c-1.302 0-2.36 1.06-2.36 2.36v7.015c0 1.303 1.058 2.363 2.36 2.363h9.004c1.302 0 2.36-1.06 2.36-2.363v-3.39c0-.655-.532-1.185-1.185-1.185h-.178c-.264 0-.476-.213-.476-.477v-1.963c0-1.3-1.057-2.36-2.36-2.36h-3.497zm2.83 7.834H9.875a.714.714 0 0 1 0-1.428h4.12a.714.714 0 0 1 0 1.428zm.685-3.206H9.875a.714.714 0 0 1 0-1.428h4.806a.714.714 0 0 1 0 1.428z"/></svg>
              <!-- fallback: show text -->
